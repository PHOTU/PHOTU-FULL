<!DOCTYPE html>
<html lang="en">
        <title>PHOTU - Astro A50 Review</title>
        <meta name="description" content="Do they justify the £250 price tag? We find out.">
...
<div class="kopa-breadcrumb">
        <div class="wrapper clearfix">
            ...
            &nbsp;|&nbsp;
            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                <a itemprop="url" href="/categories/reviews">
            ...
            <span itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="">
                <a itemprop="url" class="current-page">
                    <span itemprop="title">Astro A50</span>
                </a>
            </span>
        </div>
    </div>
                    ...
                    <div class="widget">
                        <div class="pd-20 kopa-entry-post">
                            <article class="entry-item">
                                <p class="entry-categories style-s"><a href="/categories/reviews">reviews</a></p>
                                ...
                                <blockquote class="kopa-blockquote style2">
                                    <p><i>At around £250 they don't exactly come cheap, is it really worth the investment?</i></p>
                                </blockquote>
